<!-- resources/views/admin/flights/create.blade.php -->
                    ...
                    <form method="POST" action="{{ route('admin.flights.store') }}">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input id="tanggal" type="date" name="tanggal" value="{{ old('tanggal') }}" class="form-input rounded-md shadow-sm mt-1 block w-full" required />
                            </div>
